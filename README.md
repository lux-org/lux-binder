...
Visit [localhost:8888](http://localhost:8888/) in your browser to access the Jupyter notebooks. 
...
Once you have your Jupyter notebook opened, navigate to the `exercise/` directory.
