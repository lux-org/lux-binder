...
Check out this [recording of a 1-hr session](https://www.youtube.com/watch?v=YANIids_Nkk) that walks through three hands-on exercise on Lux.
To follow along, you can clone this repo to follow along the instructions in the notebooks.
...
<a href='https://mybinder.org/v2/gh/lux-org/lux-binder/master?urlpath=lab/tree/exercise'>
...
**Option #2:** Download and install [Docker](https://www.docker.com/get-started), then run: 
